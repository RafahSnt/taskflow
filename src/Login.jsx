...
export default function Login({ onLogin }) {
  ...
  function handleCadastro(e) {
    ...
    if (USUARIOS_MOCK.find((u) => u.email === cadastro.email)) {
      setErro('Este email já está cadastrado.');
      return;
    }

    const novo = { id: Date.now(), nome: cadastro.nome, email: cadastro.email, senha: cadastro.senha, funcao: cadastro.funcao };
  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420, padding: '0 1.5rem' }}>
        ...
        {/* Abas Login / Cadastro */}
        <div style={{
          display: 'flex', background: '#e8e8e4', borderRadius: 10,
          ...
          {['login', 'cadastro'].map((t) => (
            <button
              key={t}
              type="button"
              onClick={() => { setTela(t); setErro(''); setSucesso(''); }}
              style={{
        ...
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e5e5e5', padding: '2rem' }}>
          ...
          {sucesso && (
            <div style={{
              background: '#f0faf5', border: '1px solid #a8e6c8', borderRadius: 8,
              padding: '10px 14px', marginBottom: '1rem', fontSize: 13,
              color: '#1a7a45', fontFamily: 'sans-serif',
            }}>
              ✓ {sucesso}
            </div>
          )}
          ...
          {erro && (
            <div style={{
              background: '#fff0f0', border: '1px solid #ffc5c5', borderRadius: 8,
              padding: '10px 14px', marginBottom: '1rem', fontSize: 13,
          ...
          {tela === 'login' && (
            <form onSubmit={handleLogin}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '1.5rem' }}>
                <input
                  type="checkbox" id="lembrar" checked={lembrar}
                  onChange={(e) => setLembrar(e.target.checked)}
                  style={{ width: 16, height: 16, cursor: 'pointer', accentColor: '#1a1a2e' }}
                />
                <label htmlFor="lembrar" style={{
                  fontSize: 13, color: '#555', fontFamily: 'sans-serif', cursor: 'pointer',
                }}>
                  Lembrar meu email
                </label>
              </div>
              ...
              <button type="submit" disabled={carregando} style={{
                ...estiloBotao, background: carregando ? '#888' : '#1a1a2e',
              ...
              <div style={{
                marginTop: '1.5rem', padding: '1rem', background: '#f8f8f8',
                borderRadius: 8, fontSize: 12, color: '#888', fontFamily: 'sans-serif',
              }}>
          ...
          {tela === 'cadastro' && (
            <form onSubmit={handleCadastro}>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <input
                  type="text" placeholder="Seu nome" value={cadastro.nome} required
              ...
              <div style={{ marginBottom: '1rem' }}>
                <label style={estiloLabel}>Email</label>
                <input
                  type="email" placeholder="seu@email.com" value={cadastro.email} required
              ...
              <div style={{ marginBottom: '1rem' }}>
                ...
                <input
                  type="text" placeholder="Ex: Desenvolvedor, Analista..." value={cadastro.funcao} required
